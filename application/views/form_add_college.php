<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">College Management Section</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
    ...
    <section class="content">
        ...
        <div class="card card-primary">
            <div class="card-header">
                <h3 class="card-title">Management of Colleges</h3>
            </div>
            <?= form_open('management/college_add') ?>
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-3 form-group">
                        ...
                        <input type="text" class="form-control" name="college_code" value="<?php echo set_value('college_code') ?>" required>
                    ...
                    <div class="col-md-3 form-group">
                        ...
                        <input type="text" class="form-control" name="college_desc" value="<?php echo set_value('college_desc') ?>" required>
        ...
        <div class="card-header">
            <h3 class="card-title">List of Colleges</h3>
        </div>
                ...
                <tbody>
                    ...
                    foreach ($colleges as $row) {  ?>
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-info btn-sm" href="#" data-toggle="modal" data-target="#modal-edit-<?php echo $row->college_code ?>">
                            ...
                            <!-- /.modal-edit -->
                            <div class="modal fade" id="modal-edit-<?php echo $row->college_code ?>">
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content form-group">
                                        ...
                                        <?= form_open_multipart("Management/college_update/" . $row->college_code) ?>
                                        <div class="modal-body">
                                            ...
                                            <div class="row ">
                                                ...
                                                <div class="col">
                                                    ...
                                                    <input type="text" name="college_code_edit" class="form-control" value="<?php echo $row->college_code ?>" readonly>

...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 30, 2023 at 10:28 AM
...
(2, '23-ENTREP-GE-105', 'BS ENTREP', 'GE 104', 'MWF-LEC1-8-10', '23-BPC-001i', 'SC-1-22-23');
...
(6, '23-BPC-001i', 'JUNIO', 'JEZREEL JOHN', 'VICTORINO', 'MR', 'Male', '2023-01-09', 'ZONE III', 'BAYAMBANG', 'PANGASINAN', '23-BPC-001i.jpg', 'PRC-2000-001', 'CME', 'Temporary', 'part_time', '2023-01-04', 'Active');
...
(59, 'GE 104', '23-BPC-001i'),
(60, 'GE 107', '23-BPC-001i');
...
--
ALTER TABLE `tbl_bpc_specialty`
  MODIFY `speciality_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=61;
